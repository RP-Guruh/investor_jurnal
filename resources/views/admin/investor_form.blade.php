                ...
                <form action="{{ url('/admin/investor/process') }}" method="post">
                    ...
                    <div class="mt-3">
                        ...
                        <div class="input-group">
                            <input name="email" id="crud-form-3" type="email" class="form-control"
                    ...
                    <div class="mt-3">
                        ...
                        <div class="input-group">
                            <input name="password" id="crud-form-3" type="text" class="form-control"
                            aria-describedby="input-group-1" required minlength="8">
                        </div>
                    </div>
