                        ...
                        <table class="table">
                            <thead>
                                <tr>
                                    ...
                                    <th class="border-b-2 dark:border-dark-5 whitespace-nowrap"> Update </th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="border-b dark:border-dark-5">
                                        <a href="{{url('admin/investor/'.$item->id_anggota.'/delete')}}" style="background-color: red;" class="hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full lg:ml-4">
                                            Hapus
                                        </a>
                                    </td>
