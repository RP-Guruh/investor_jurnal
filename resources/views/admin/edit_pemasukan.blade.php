            ...
            <div class="intro-y box p-5">
                <form action="{{ url('/admin/pemasukan/update') }}" method="post">
                    ...
                    <div>
                        ...
                        <input name="id_pemasukan" id="crud-form-1" type="text" class="form-control w-full"
                             readonly value="{{ $id_pemasukan }}">
                    </div>
                    ...
                    <div class="mt-3">
                        ...
                        <div class="input-group">
                            <input name="nominal" id="crud-form-3" type="number" class="form-control"
                                placeholder="Nominal" aria-describedby="input-group-1" value="{{ $item->nominal }}">
                    ...
                    <div class="mt-3">
                        ...
                        <div class="input-group">
                            <input value="{{ $item->tanggal_pemasukan }}" name="tgl_pemasukan" id="crud-form-3" type="date" class="form-control"
                    ...
                    <div class="mt-3">
                        ...
                        <div class="input-group">
                            <textarea name="keterangan" id="crud-form-3" rows="10" class="form-control"
                                aria-describedby="input-group-1"> {{$item->keterangan}} </textarea>
                        </div>
                    </div>
