            ...
            <div class="intro-y box p-5">
                <form action="" method="post">
                    ...
                    <div>
                        ...
                        <input id="crud-form-1" type="text" class="form-control w-full" placeholder="{{ $id }}"
                            readonly>
                    </div>
                    ...
                    <div class="mt-3">
                        ...
                        <div class="input-group">
                            <input id="crud-form-3" type="number" class="form-control" placeholder="Nominal"
                    ...
                    <div class="mt-3">
                        ...
                        <div class="input-group">
                            <input id="crud-form-3" type="date" class="form-control" aria-describedby="input-group-1">
                    ...
                    <div class="mt-3">
                        ...
                        <div class="input-group">
                            <textarea id="crud-form-3" rows="10" class="form-control"
