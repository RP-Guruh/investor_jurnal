    ...
    <div class="block xl:grid grid-cols-2 gap-4">
        ...
        <div class="hidden xl:flex flex-col min-h-screen">
            <a href="" class="-intro-x flex items-center pt-5">
                <img alt="Icewall Tailwind HTML Admin Template" style="width: 200px;" src="{{ asset('dist/images/alkahf.png') }}">
                <img alt="Icewall Tailwind HTML Admin Template" style="width: 200px;" src="{{ asset('dist/images/mpi.png') }}">

            </a>
            <div class="my-auto">
                <img alt="Icewall Tailwind HTML Admin Template" class="-intro-x w-1/2 -mt-16" src="{{ asset('dist/images/illustration.svg') }}">
                <div class="-intro-x text-white font-medium text-4xl leading-tight mt-10">Al Kahfi <br> Laporan Keuangan Jurnal</div>
                <div class="-intro-x mt-5 text-lg text-white text-opacity-70 dark:text-gray-500">
                    Ketahui laporan keuangan jurnal hanya dengan satu genggaman
                </div>
            </div>
        </div>
        <!-- END: Login Info -->
        ...
        <div class="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
            <div class="my-auto mx-auto xl:ml-20 bg-white dark:bg-dark-1 xl:bg-transparent px-5 sm:px-8 py-8 xl:p-0 rounded-md shadow-md xl:shadow-none w-full sm:w-3/4 lg:w-2/4 xl:w-auto">
                <h2 class="intro-x font-bold text-2xl xl:text-3xl text-center xl:text-left">Silahkan Sign In</h2>
                <div class="intro-x mt-2 text-gray-500 xl:hidden text-center"> Ketahui laporan keuangan jurnal hanya dengan satu genggaman</div>
                ...
                <div class="intro-x mt-10 xl:mt-24 text-gray-700 dark:text-gray-600 text-center xl:text-left">
                    Pelajari tentang kami <br> <a class="text-theme-1 dark:text-theme-10" href="">Terms and Conditions</a> & <a class="text-theme-1 dark:text-theme-10" href="">Privacy Policy</a>
                </div>
                <div class="intro-x mt-4 xl:mt-24 text-gray-700 dark:text-gray-600 text-center xl:text-left">
                    Code With Love <br> <a class="text-theme-1 dark:text-theme-10" href="">&copy;2021</a>
                </div>
